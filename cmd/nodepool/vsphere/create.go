...
func NewCreateCommand(coreOpts *core.CreateNodePoolOptions) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:          "kubevirt",
		Short:        "Creates basic functional NodePool resources for VSphere platform",
		SilenceUsage: true,
	}
...
func (o *KubevirtPlatformCreateOptions) UpdateNodePool(_ context.Context, nodePool *hyperv1.NodePool, _ *hyperv1.HostedCluster, _ crclient.Client) error {
	nodePool.Spec.Platform.VSphere = fixtures.ExampleVSphereTemplate(&fixtures.ExampleVSphereOptions{
		Memory:                 o.Memory,
		Cores:                  o.Cores,
